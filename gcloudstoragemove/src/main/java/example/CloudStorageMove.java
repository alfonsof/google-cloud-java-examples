...
public class CloudStorageMove {
    public static void main(String[] args) throws IOException {
        ...
        if (args.length < 3) {
            System.out.println("Not enough parameters.\nProper Usage is: java -jar gcloudstoragemove.jar <SOURCE_BUCKET> <SOURCE_OBJECT> <DESTINATION_BUCKET>");
            System.exit(1);
        }
            ...
            if (destinationBucket != null) {   // Exists destination bucket
                ...
                if (copiedBlob != null) {
                    ...
                    if (deleted) {
                        ...
                        System.out.println("Error: Object does NOT moved (not deleted)");
                    }
                } else {
                    System.out.println("Error: Object does NOT moved (not copied)");
                }
            } else {
